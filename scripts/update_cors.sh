...
# Backup original
cp agent_server.py agent_server.py.backup

# Create updated version with CORS restriction
...
echo "✅ agent_server.py updated with CORS restrictions"
echo ""
echo "📌 Before deploying to Vercel, update ALLOWED_ORIGINS:"
echo "   Edit ~/claude-agent/backend/agent_server.py"
echo "   Replace 'your-vercel-app.vercel.app' with your actual Vercel URL"
echo ""
